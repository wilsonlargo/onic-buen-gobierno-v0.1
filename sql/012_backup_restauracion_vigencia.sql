...
-- Migración 012 · Copia de seguridad y restauración de Vigencias
-- v0.7.6
-- ==========================================================
--
-- 1) Ajusta el importador para reconocer archivos generados como
--    copia de seguridad y preservar sus ponderaciones exactas.
-- 2) Agrega exportar_vigencia_json(uuid), cuyo resultado utiliza
--    exactamente el formato onic-buen-gobierno.v1.
-- 3) El archivo exportado puede restaurarse con "Importar vigencia".
-- ==========================================================

create or replace function public.importar_vigencia_json(
  p_payload jsonb
)
returns jsonb
language plpgsql
...
revoke all
on function public.importar_vigencia_json(jsonb)
from public;
...
-- ==========================================================
-- COPIA DE SEGURIDAD / EXPORTACIÓN DE VIGENCIA
-- ==========================================================

create or replace function public.exportar_vigencia_json(
  p_vigencia_id uuid
)
returns jsonb
language plpgsql
...
revoke all
on function public.exportar_vigencia_json(uuid)
from public;
